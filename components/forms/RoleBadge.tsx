...
export const AddRole = React.forwardRef<any, AddRoleProps>(({ className, onClick }, ref) => {
  return (
    <span className={`d-inline-block cursor-pointer ${className}`} onClick={onClick} ref={ref}>
      <div className="d-flex align-items-center" style={{ border: `1px solid gray`, borderRadius: '50px' }}>
        <div className={cx("d-flex", "align-items-center", "justify-content-center")} style={{ width: 16, height: 16, margin: 5 }}>
