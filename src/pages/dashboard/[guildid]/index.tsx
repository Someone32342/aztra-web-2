...
export const getServerSideProps: GetServerSideProps<MainRouterProps> = async (
  context
) => {
                      ...
                      <Card.Body className="pt-3">
                        <Card.Title className="font-weight-bold d-flex justify-content-between align-items-center">
                          ...
                          <Link
                            ...
                            shallow
                          >
                            <Button variant="dark" size="sm" className="m-0">
                              관리하기
                            </Button>
                          </Link>
                        </Card.Title>
                            ...
                            <>
                              <div>
                                <CheckIcon
                                  ...
                                  htmlColor="limegreen"
                                />
                                <b>{autotasking.length}</b>개의 자동 작업 사용중
                              </div>
                            </>
                          ) : (
                            <>
                            ...
                            <>
                              <div>
                                <CheckIcon
                                  ...
                                  htmlColor="limegreen"
                                />
                                <b>{ticketsets.length}</b>개의 티켓 사용중
                              </div>
                            </>
                          ) : (
                            <>
                ...
                <Row className="mt-5">
                  <Col className="mb-5" xs={12} lg={6}>
                    <div className="d-flex justify-content-between">
                      ...
                      <div>
                        <Link
                          href={`/dashboard/${guildId}/warns/list`}
                          passHref
                        >
                          <Button
                            variant="aztra"
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                      ...
                                      >
                                        ...
                                        >
                                          <img
                                            src={
                                              target.avatar
                                                ? `https://cdn.discordapp.com/avatars/${target.id}/${target.avatar}`
                                ...
                                <Col
                                  xs={3}
                                  className="d-flex px-2 align-items-center my-0 justify-content-end"
                                >
                                  <div
                  ...
                  <Col className="mb-5" xs={12} lg={6}>
                    <div className="d-flex justify-content-between">
                      ...
                      <div>
                        <Link href={`/dashboard/${guildId}/members`} passHref>
                          <Button
                            variant="aztra"
                            className="shadow align-items-center d-flex"
                            size="sm"
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                                  ...
                                  >
                                    ...
                                    >
                                      <img
                                        src={
                                          one.user.avatar
                                            ? `https://cdn.discordapp.com/avatars/${one.user.id}/${one.user.avatar}`
                                            : one.user.defaultAvatarURL
                                        }
                                        alt={one.user.tag!}
                                        className="rounded-circle no-drag"
                                        style={{
                              ...
                              >
                                <div
                                  className="my-auto small text-right"
                                  style={{
                                    color: 'lightgrey',
                                  }}
                                >
