  ...
  const TicketsetListCard: React.FC<TicketsetListCardProps> = ({
    ...
    const Actions: React.FC = () => (
      <ButtonGroup>
        <OverlayTrigger
          placement="top"
          overlay={<Tooltip id="task-list-row-remove-task">티켓 목록</Tooltip>}
        >
          <Button
            variant="dark"
        ...
        <OverlayTrigger
          placement="top"
          overlay={
            <Tooltip id="task-list-row-remove-task">티켓 세부 설정</Tooltip>
          }
        >
          <Button
            variant="dark"
              ...
              <div>
                <Row className="dashboard-section">
                  <div>
                    <h3>티켓 설정</h3>
                    <div className="py-2">
                      유저가 티켓을 생성하면 서버에 개별 채널이 생성되어
                      이곳에서 1:1 문의/신고 등을 진행할 수 있습니다.
                    </div>
                  </div>
                </Row>
                <Row>
                      ...
                      <Row>
                        ...
                        >
                          ...
                          <Modal.Body className="py-4">
                            선택한 티켓 설정 {finalSelectedSet.size}개를
                            제거하시겠습니까?
                          </Modal.Body>
