  ...
  return (
    <>
      ...
      <Layout>
        ...
        <div
          id="features-begin"
          style={{ marginTop: '-58px', marginBottom: 58 }}
        />
        <div id="statistics" className={cx('MainStatistics')}>
          <div
            style={{
              background: 'linear-gradient(210deg, #6799FF, #4375DB)',
              height: '65vh',
            }}
          >
                ...
                <Col lg={{ offset: 1 }} className="text-center text-lg-left">
                  <div>
                    <div className="py-4">
                      ...
                      <div className={cx('UsingServersCount')}>
                        {numberWithCommas(data?.servers ?? 0)}
                      </div>
                    </div>
                    <div className="py-4">
                      <div className={cx('UsingServersTitle')}>
            ...
            <Container className="d-lg-flex align-items-center justify-content-between">
              <div className="d-flex justify-content-center">
                <Image
                  ...
                  alt="경고 설정"
                  src="/assets/images/Home/feat-warn.png"
                  priority
                  width={366}
                  height={284}
                />
              ...
              <div className={cx('MainFeaturesItemContent')}>
                ...
                <p>
                  기존의 헷갈리고 복잡한 관리봇이 아닌, 사용자 친화적으로 설계된
                  쉬운 사용법으로 여러분의 서버를 더 성장시킬 수 있습니다.
                </p>
              </div>
            </Container>
          </div>
          ...
          >
            <Container className="d-lg-flex align-items-center justify-content-between flex-row-reverse">
              ...
              <div className={cx('MainFeaturesItemContent')}>
                ...
                <p>
                  Aztra 대시보드는 모바일에서도 언제 어디서나 사용하기 편하도록
                  모바일 환경에도 신경써서 개발하고 있습니다.
                </p>
              </div>
            </Container>
          </div>
            ...
            <Container className="d-lg-flex align-items-center justify-content-between">
              <div className="d-flex justify-content-center">
                <Image
                  className="shadow"
                  alt="멤버 관리"
                  src="/assets/images/Home/member-manage.png"
                  priority
                  width={500}
                  height={281.25}
                />
              ...
              <div className={cx('MainFeaturesItemContent', 'ml-lg-5')}>
                ...
                <p>
                  ...
                  대시보드를 통해 명령어만으로는 경험하지 못했던 매우 다양한
                  기능들을 제공합니다.
                </p>
              </div>
            </Container>
