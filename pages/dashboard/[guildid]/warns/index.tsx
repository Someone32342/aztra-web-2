...
class WarnsMain extends React.Component<WarnsMainRouterProps & WithRouterProps, WarnsMainState> {
                ...
                <Row>
                  <Col className="mb-5" xs={12} lg={6}>
                    <div className="d-flex justify-content-between">
                      ...
                      <div>
                        <Link href={`/dashboard/${this.props.guildId}/warns/list`}>
                              ...
                              <Card.Body as={Row} className="py-1 d-flex justify-content-between">
                                <Col xs={9} className="d-flex px-2">
                                  <div className="mr-2 my-auto" style={{
                                    ...
                                    >
                                      <Link href={`/dashboard/${this.props.guildId}/members/${target?.id}`}>
                                        <img
                            ...
                            return (
                              <Card bg="dark" className="mb-2 shadow-sm shadow">
                                <Card.Body className="py-2">
                                  ...
                                  {`${rank}위 - `}
                                  <Link href={`/dashboard/${this.props.guildId}/members/${target?.user.id}`}>
...
export default withRouter(WarnsMain)